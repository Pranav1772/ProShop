...
import { Link, redirect, useNavigate, useParams, useLocation } from "react-router-dom";
  ...
  return (
    <FormContainer>
      ...
      <Form onSubmit={submitHandler}>
        ...
        <Form.Group controlId="passwordconfermed">
          <Form.Label>Confirm Password</Form.Label>
          <Form.Control type="password" placeholder="Confirm Password" value={confirmedPassword} onChange={(e) => setConfirmedPassword(e.target.value)} required></Form.Control>
        </Form.Group>
